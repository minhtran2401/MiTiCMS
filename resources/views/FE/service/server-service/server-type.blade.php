@extends('FE.layout')
@section('pagetitle', " $server_type->service_type_name ")
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card" style="overflow: hidden">
                    <div class="shin-title-page">
                        <h3>MiTiVPS - VPS - {{$server_type->service_type_name}}</h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row justify-content-center mb-5">
                                        <div class="col-12 text-center heading-section ftco-animate">
                                            ...
                                            <div class="row justify-content-center mb-3">
                                                <div class="">
                                                    @php 
                            $servers = DB::table('service_types')->where('service_group_id','1')->where('display','1')->get();
                        @endphp
                        @foreach ($servers as $server)
                         <div class="shin-service-menu-type"><a style="color: white" href="{{route('server.server-type',$server->slug)}}">{{$server->service_type_name}}</a></div>
                                                          ...
                                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                              <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLongTitle">Giá gói {{$server_type->service_type_name}}</h5>
...
var reurl = "{{route('purchase_server')}}";
$.ajax({
       type: "POST",
       url: url,
