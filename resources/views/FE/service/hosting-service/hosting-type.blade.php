@extends('FE.layout')
@section('pagetitle', " $hosting_type->service_type_name ")
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card" style="overflow: hidden">
                    <div class="shin-title-page">
                        <h3>MiTiVPS - VPS - {{$hosting_type->service_type_name}}</h3>
                    </div>
                    <div class="card-body">
                                                          ...
                                                          <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                              <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLongTitle">Giá gói {{$hosting_type->service_type_name}}</h5>
                                                              ...
                                                              <div class="modal-body">
                                                                  <table class="table tableshow" >
                                                                      ...
                                                                      <tbody>
                                                                          @php
                                                                          $hosting_price = DB::table('service_price')->where('sku',$detail->sku)->get();
                                                                         @endphp
                                                                          @foreach ($hosting_price as $key => $price)
                                                                        <tr>
...
var reurl = "{{route('purchase_hosting')}}";
$.ajax({
       type: "POST",
       url: url,
