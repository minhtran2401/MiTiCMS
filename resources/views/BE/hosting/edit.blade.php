...
@section('pagetitle','Sửa thông tin Hosting')
@section('csspage')
...
@section('br-namepage2','Hosting')
@section('br-namepage3','Sửa Hosting')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form name="formedit" action="{{ route('hosting.update',$row->hosting_id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 row col-12">
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <input name="name_service" type="text" class="form-control"  placeholder="Tên Hosting" value="{{$row->hosting_name}}" />
                                        </div>
                                        <div class="col-md-12 mb-1">
                                    ...
                                    <div class="col-md-7 row col-12 ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div data-id="{{$pri->service_price_id}}" class="row" id="row-price-{{$pri->service_price_id}}">
                                                ...
                                                <small class="font-weight-semibold w-100 ml-1 my-1">Giá thuê Hosting - Gói {{$key + 1}}</small>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card"> 
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <textarea  cols="30" rows="10" class="form-control" id="summernote" name="hosting_profile">
                                                                                    {!! $row->hosting_profile !!}
                                                                            </textarea> 
                                                                        </div>
                                                                    </div>
