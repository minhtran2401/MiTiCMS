            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary">Check đơn</button>
                ...
                <div class="card card-statistics">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <p class="card-text font-small-2 mr-25 mb-0">Cập nhật 1 tháng trước</p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                <div class="media">
                                    ...
                                    <div class="media-body my-auto">
                                        <h4 class="font-weight-bolder mb-0">{{$data['truycap']}}</h4>
                                        <p class="card-text font-small-3 mb-0">Truy cập</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            ...
                            <div class="col-xl-3 col-sm-6 col-12">
                                <div class="media">
                                    ...
                                    <div class="media-body my-auto">
                                        <h4 class="card-text font-small-3 mb-0">{{$data['thunhap']}}</h4>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-lg-6 col-md-3 col-6">
                        <div class="card">
                            <div class="card-body pb-50">
                                <h6>Đã thanh toán</h6>
                                <h2 class="font-weight-bolder mb-1">{{$data['billed']}} đơn</h2>
                    ...
                    <div class="col-lg-6 col-md-3 col-6">
                        <div class="card card-tiny-line-stats">
                            <div class="card-body pb-50">
                                <h6>Tiền vốn</h6>
                                <h2 class=" card-text font-small-3 mb-0">{{$data['tienvon']}}</h2>
                    ...
                    <div class="col-lg-12 col-md-6 col-12">
                        <div class="card earnings-card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 class="card-title mb-1">Tổng thu</h4>
                                        <div class="font-small-2">Tháng này</div>
                                        <h5 class="mb-1">{{$data['tienloi']}}</h5>
                                        <p class="card-text text-muted font-small-2">
                                            <span class="font-weight-bolder">68.2%</span><span> Tăng so với tháng trước</span>
                                        </p>
                                    </div>
                                    <div class="col-6">
