...
@section('pagetitle','Thêm Phương Thức')
@section('csspage')
...
@section('br-namepage3','Thêm phương thức thanh toán')
       <div class="content-body">
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-primary" role="alert">
                        <div class="alert-body">
                            <strong>Ghi chú:</strong> Thêm phương thức thanh toán.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="" id="form_validation" method="POST" action="{{route('payment-method.store')}}" enctype="multipart/form-data" >
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tên" name="name_payment">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group ">
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="display" id="Hien" class="form-check-input" value="1"checked >
                                                <label class="form-check-label" for="Hien">Hiện</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input type="radio" name="display" id="An" class="form-check-input" value="0" >
                                ...
                                <div class="col-md-6">   
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea id="summernote" name="info_payment" id="" cols="30" rows="10"></textarea>
