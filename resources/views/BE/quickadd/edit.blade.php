            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="" id="form_validation" method="POST" action="{{route('blog.update',$row->blog_id)}}" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            @method('patch')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Tên" name="blog_name" value="{{$row->blog_name}}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                @if ($row->blog_type_id == $theloai->blog_type_id)
                                <option value='{{$theloai->blog_type_id}}' selected >{{$theloai->blog_type_name}}</option>  
                                @else
                            ...
                            <input hidden  type="text" name="blog_view" value="{{$row->blog_view}}">
                            <div class="form-group col-md-12">
                              ...
                              <div class="form-group col-md-12">
                                <label for="blog_post_time">Ngày Đăng</label>
                                  <input  readonly   type="text" class="form-control datepicker" value="{{$row->blog_post_time}}"  name="blog_post_time" >
                              </div>
        
                              <div class="form-group col-md-12">
                                <label for="blog_tag">Tag</label>
                                  <input type="text" class="form-control " value="{{$row->blog_tag}}" placeholder="Các tag ngăn cách nhau bời dấu phẩy"  name="blog_tag">
                        ...
                        <div class="col-md-6">   
                            <div class="form-group col-md-12">
                                ...
                                <textarea id="summernote" name="blog_summary" id="" cols="30" rows="10">{{$row->blog_summary}}</textarea>
                        ...
                        <div class="col-sm-md mb-3">
                            <label for="blog_content"> Nội Dung </label>
                                <textarea name="blog_content" id="summernote2">{{$row->blog_content}}</textarea>
                        ...
                        <div class="col-md-12 row">
                            ...
                            <div class="form-group col-md-4">
                              <div class="form-check form-check-inline">
                                  <input type="radio" name="blog_special" id="co" class="form-check-input" value="1" @if ($row->blog_special == 1) checked @endif>
                                  <label class="form-check-label" for="co">Nổi Bật</label>
                              </div>
                              <div class="form-check form-check-inline">
                                  <input type="radio" name="blog_special" id="khong" class="form-check-input" value="0" @if ($row->blog_special == 0) checked @endif >
