...
@section('pagetitle','Trang hệ điều hành')
@section('csspage')
...
@endsection
@section('content')
@section('br-namepage1','Hệ Điều Hành')
@section('br-namepage2','Hệ Điều Hành')
@section('br-namepage3','Danh Sách Hệ Điều Hành')
                ...
                <div class="col-12">
                    <div class="alert alert-primary" role="alert">
                        <div class="alert-body">
                            <strong>Ghi chú:</strong> Danh Sách Hệ Điều Hành
          ...
          <section id="basic-data" >
                     ...
                     <table class="table table-striped" id="table-1">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <td><div>{{$row->name_location}}</div></td>
                          
                       <td  class="text-center">
                      <form class="form-check-inline" action="{{route('hdh.destroy', $row->id)}}" method="POST">
                              @csrf
            ...
            <div class="modal modal-slide-in fade" id="modals-slide-in">
              <div class="modal-dialog sidebar-sm">
                  <form id="create-groups-service" method="POST" action="{{route('hdh.ajax')}}" class="add-new-record modal-content pt-0">
                      @csrf
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                      <div class="modal-header mb-1">
                          <h5 class="modal-title" id="exampleModalLabel">Thêm Hệ Điều Hành Mới</h5>
                      </div>
                      <div class="modal-body flex-grow-1">
                          <div class="form-group">
                              <label class="form-label" for="basic-icon-default-fullname">Tên Khu Vực</label>
                              <input type="text" name="name_location" class="form-control dt-full-name" id="basic-icon-default-fullname" placeholder="Tên HĐH" required  />
                          </div>
