...
@endsection
@section('content')
@section('br-namepage1','Dịch Vụ VPS')
@section('br-namepage2','Dịch vụ')
@section('br-namepage3','VPS')
       <div class="content-body">
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-primary" role="alert">
                        <div class="alert-body">
                            <strong>Ghi chú:</strong> Thêm dịch vụ VPS của website.
                        </div>
                    </div>
                </div>
            </div>
...
@section('pagevendor')
    ...
    <script src="{{asset('BE')}}/app-assets/vendors/js/editors/quill/katex.min.js"></script>
    <script src="{{asset('BE')}}/app-assets/vendors/js/editors/quill/highlight.min.js"></script>
