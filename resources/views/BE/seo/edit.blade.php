...
@section('pagetitle','Sửa thông tin Meta')
@section('csspage')
...
@section('br-namepage3','Sửa Meta')
       <div class="content-body">
            <div class="row">
                <div class="col-12">
                    <div class="alert alert-primary" role="alert">
                        <div class="alert-body">
                            <strong>Ghi chú:</strong> Sửa meta của website.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form name="formedit" action="{{ route('seo.update',$row->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 row col-12">
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <input name="meta_name" type="text" class="form-control"  placeholder="Meta name" value="{{$row->meta_name}}" /> <br>
                                            <label>Nội dung meta</label>
                                            <input name="meta_content" type="text" class="form-control"  placeholder="Meta content" value="{{$row->meta_content}}" />
                                        </div>
