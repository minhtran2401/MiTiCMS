...
@section('pagetitle','Sửa thông tin tài khoản')
@section('csspage')
                ...
                <div class="col-12">
                    <div class="alert alert-primary" role="alert">
                        <div class="alert-body">
                            <strong>Ghi chú:</strong> Sửa dịch vụ tài khoản của website.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <form name="formedit" action="{{ route('account.update',$row->account_id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-7 row col-12 ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div data-id="{{$pri->service_price_id}}" class="row" id="row-price-{{$pri->service_price_id}}">
                                                ...
                                                <small class="font-weight-semibold w-100 ml-1 my-1">Giá thuê tài khoản - Gói {{$key + 1}}</small>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card"> 
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <textarea  cols="30" rows="10" class="form-control" id="summernote" name="account_info">
                                                                                    {!! $row->account_info !!}
                                                                            </textarea> 
                                                                        </div>
                                                                    </div>
